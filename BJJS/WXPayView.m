...
- (instancetype)initWithMoney:(NSString *)money cardMessage:(NSString *)cardMessage completion:(WXPayViewCompletion)completion{
...
- (void)setupContents{
    self.moneyL.text = [NSString stringWithFormat:@"%@", self.money];
    self.cardMessageL.text = self.cardMessage;
    NSString *cardMessage = [NSString stringWithFormat:@"%@",self.cardMessage];
